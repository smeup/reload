...
import com.smeup.reload.sql.utils.*
...
class SQLMunicipalityTest {
    ...
    @Test
    fun t04B_findLastOfBergamoWithSetGt4AndReadPE2() {
        val dbFile = dbManager.openFile(MUNICIPALITY_TABLE_NAME)
        assertTrue(dbFile.setgt(buildMunicipalityKey("IT", "LOM", "BS", "ACQUAFREDDA")))
        assertEquals("ACQUAFREDDA", getMunicipalityName(dbFile.readPreviousEqual(buildMunicipalityKey("IT", "LOM")).record))
        assertEquals("ZOGNO", getMunicipalityName(dbFile.readPreviousEqual(buildMunicipalityKey("IT", "LOM")).record))
        dbManager.closeFile(MUNICIPALITY_TABLE_NAME)
    }
    ...
    @Test
    fun t07_findAllOfBresciaAfterVioneWithSetGt4AndReadE3() {
        val dbFile = dbManager.openFile(MUNICIPALITY_TABLE_NAME)
