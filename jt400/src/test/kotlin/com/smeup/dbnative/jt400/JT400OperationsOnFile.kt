...
class JT400OperationsOnFile {
    ...
    fun `setll and readequal by key V£CDC V£DATA`() {
        ...
        println(">Close table $tableName")
        dbManager.closeFile(tableName)
        assertEquals(6156, readedRecord)
    }
